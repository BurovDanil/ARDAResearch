...
\begin{document}
	...
	\section{Results}
	\includegraphics{EfficientNoSwitch}
	\includegraphics{EfficientSwitch}
	\includegraphics{ExperimentAverageTime}
	\includegraphics{ExperimentCli}
	\includegraphics{ExperimentGui}
	\includegraphics{GitYearsExperience}
	\includegraphics{OSAffectsInterface}
	\includegraphics{SpeedNoSwitch}
	\includegraphics{SpeedSwitch}
	\includegraphics{ProgrammingYears}
	\includegraphics{SwitchingCLI}
	\includegraphics{SwitchingGUI}
	\includegraphics{TimeSpentGit}
	\includegraphics{WordsCLIFromCLI}
	\includegraphics{WordsGUIfromGUI}
	\includegraphics{WordsGUIfromCLI}
	\includegraphics{WordsCLIFromGUI}
	\includegraphics{YearsGitImpact}
	\includegraphics{preferredInterface}
	%Survery results%
	%Experiment results%
	%Data analysis%
	\newpage
